% output = RendezvousGPOPS(x_init, x_tgt, tt);
...
% Time
t0 = 0;
tfmin = 60*42; % 1 min (in seconds)
tfmax = 60*42; % safety bound ?? 3 hours?  working in SECONDS

% Fixed initial conditions of states
x0 = -38.9328*1000; % m % these distances need to be in bounds to make HCW applicable
y0 = -100*1000; % m
...
xmin = -200*1000; % these should be based off of natural circumnavigation results
xmax = 200*1000; % these are all in (m)
ymin = -200*1000;
ymax = 200*1000;
zmin = -200*1000;
zmax = 200*1000;
